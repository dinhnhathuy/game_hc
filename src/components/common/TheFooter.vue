            ...
            <div class="row mt-5 pt-4 border-top">
                <div class="col-md-6 col-lg-8 mb-md-0 mb-4">
                    <p class="copyright mb-0">
                        Copyright ©2022 All rights reserved. | This template is made with <i class="ion-ios-heart"
                ...
                <div class="col-md-6 col-lg-4 text-md-right">
                    <ul class="ftco-footer-social p-0">
                        <li class="ftco-animate"><a href="#" data-toggle="tooltip" data-placement="top" title=""
                                data-original-title="Twitter"><img src="/images/icon/twitter.svg" class="twitter-icon"></a></li>
                        <li class="ftco-animate"><a href="#" data-toggle="tooltip" data-placement="top" title=""
                                data-original-title="Facebook"><img src="/images/icon/facebook.svg" class="facebook-icon"></a></li>
                        <li class="ftco-animate"><a href="#" data-toggle="tooltip" data-placement="top" title=""
                                data-original-title="Instagram"><img src="/images/icon/youtube.svg" class="youtube-icon"></a></li>
                    </ul>
                </div>
            </div>
        </div>
